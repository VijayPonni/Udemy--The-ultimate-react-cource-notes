...
export default function StarRating(
    ...
    return (
        ...
        >   
            ...
            <p style={textStyle}>{ messages.length === maxStarCount ? messages[ tempRating ? tempRating - 1: rating - 1] :tempRating || rating  || "" }</p>
        </div>
    )
}

function Star({ isFull, handleClick, handleMouseEnter, handleMouseLeave , color , size }) {   
